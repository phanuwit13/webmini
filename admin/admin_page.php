...
<body >
    ...
    <nav>
        <p><?php echo $objResult["username"];?> <a href="dataUser.php?userID=<?php echo $result["userID"];?>">edit</a> </p>
    ...
    <main>
    <div align="center"> <form   method = "post" action     = "<?php echo $_SERVER['SCRIPT_NAME'];?>">
        ...
        <table width="100%" style="text-align:center">
            ...
            <tr>
              ...
              <td><a href="editUser.php?userID=<?php echo $result["userID"];?>">edit</a> </td>
